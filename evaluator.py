...
######## MAX CARD OF A PACKING EVALUATION   ########
        ...
        try:    
            ...
            if returned_max == expected_max:
                ...
                turn_off_tell_max_goal_flags(m,n)
                if returned_max > expected_max:
                    print(f"We disbelieve you can pack {returned_max} 1,3-bars within a {m}x{n}-grid.  Are you sure?\n In case you can exhibit such a packing, please contact turingarena.org, we look forward to see it." )
                else:
                    print(f"You can actually pack up to {expected_max} 1,3-bars within a {m}x{n}-grid. If you disbelieve this and/or need help, have a look at the packing offered in the file: ... ")
...
######## BRGIN PACKING CONSTRUCTION VERIFICATION   ########
